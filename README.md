...
3. Eigen Portfolio Replication - This is an exercise that explains how to construct an optimal portfolio using the principal components of a basket of securities. The appeal of this approach is the orthogonality of returns among those principal factors. Specifically, we want to construct a survivorship bias free portfolio that corresponds to the constituents of an index at point in time.
