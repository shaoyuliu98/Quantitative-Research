...
from performance import Trading_Strategy
import pytz
import matplotlib.pyplot as plt
import matplotlib
import price_to_info as pti
import warnings
...
if __name__ == '__main__':
    ...
    et = tz.localize(datetime(2024, 8, 1))

    filename = './data/ETF for Momentum.csv'
    ...
    for i in [etf_list,
        ...
        temp_perf = Trading_Strategy(temp_return.loc[temp_return['date'] >= strategy_cutoff], 'Monthly').get_metrics_table()
